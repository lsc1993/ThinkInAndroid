 ...
 * Use the [PropertyAnimatorFragment.newInstance] factory method to
...
class PropertyAnimatorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PropertyAnimatorFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PropertyAnimatorFragment().apply {
