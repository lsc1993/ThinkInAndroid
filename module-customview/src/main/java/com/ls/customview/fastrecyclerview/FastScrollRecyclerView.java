...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    protected int getAvailableScrollHeight(int adapterHeight, int yOffset) {
        ...
        return scrollHeight - visibleHeight - 150;
    }
    ...
    protected void updateThumbPosition(ScrollPositionState scrollPosState, int rowCount) {
        ...
        availableScrollBarHeight = getAvailableScrollBarHeight() - 150;
    ...
    public String scrollToPositionAtProgress(float touchFraction) {
        ...
        if (touchFraction - 0.99f > 0.0001f) {
            layoutManager.scrollToPositionWithOffset(getAdapter().getItemCount() - 1, scrollOffset);
        } else {
